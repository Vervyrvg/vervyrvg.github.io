...
const education: Education[] = [
    {
        ...
        description: "Adquirí conocimientos en ciberseguridad, especializándome en l protección de redes, fortaleciendo habilidades en análisis de riesgos, prevención de vulnerabilidades y configuración de sistemas seguros.",
        currentUni: false,
    },
];
