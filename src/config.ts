...
export const SITE = {
    website: "https://vervyrvg.github.io/", // reemplaza con tu dominio desplegado
    title:  "https://vervyrvg.github.io/proyects",
...
export const SOCIALS = [
    ...
    {
        name: "Twitter",
        url: "https://twitter.com/vicboxdev",  // Cambia esta URL por la correcta si la tienes
        icon: "twitter-x-fill",
        show: true,
    },
    {
        name: "Instagram",
        url: "mailto:victorresendizv@outlook.com",  // Cambia por la URL correcta si quieres
        icon: "instagram-fill",
        show: true,
    },
    {
        name: "Youtube",
        url: "https://www.linkedin.com/in/victor-eduardo-resendiz-villegas-910a80290", // Cambia por tu URL correcta de Youtube si tienes
        icon: "youtube-fill",
        show: true,
    },
    {
